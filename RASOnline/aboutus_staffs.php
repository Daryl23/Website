...
<tr><tr><br>
	...
	<img src="RASpics/logos.jpg" width='300' height='80'/>
			...
			<div style="float:left; width:600px;">
						<br></br>
						<b><h4 style="color: #2E8B57;padding-left:0.5cm;">STAFFS</b></h4>
						
		<?php
						$q1=mysql_query("SELECT FacultyId, FacultyName, FacultyPosition, FacultyImage FROM faculties WHERE FacultyCategory='Staff'") or die(mysql_error());
