	...
	<img src="RASpics/logos.jpg" width='300' height='80'/>
					...
					?>
						...
						<head>
							...
							<br></br>
							<br></br>
							<div class="g6" style="margin-top:140px">
			...
			<div style="float:left; width:600px;">
						<br></br>
						<b><h4 style="color: #2E8B57;padding-left:0.5cm;">ADMINISTRATORS</b></h4>
						
						
					<?php
						$q1=mysql_query("SELECT FacultyId, FacultyName, FacultyPosition, FacultyImage FROM faculties WHERE FacultyCategory='Administrator'") or die(mysql_error());
					...
					?>
							...
							<table cellspacing="5" cellpadding="0" width="600px" bgcolor="#ffffff" border="0" style="margin-left:0.3cm;">
								<tr valign="top">
								  <td>
						...
						<div class="cleaner_h20 horizon_divider" style="margin-top:-0.4cm;width:570px;"></div>
					<?php
					}
					?>
				</div>	
