...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
						...
						$sql = "SELECT COUNT(*) FROM newsevents WHERE newscategory='news'";
						...
						$sql = "SELECT * FROM newsevents WHERE newscategory='news' LIMIT $offset, $rowsperpage";
						...
						if ($currentpage > 1) {
						   ...
						   echo '<div style="text-align:center;">';
						   echo " <a href='?pg=news&currentpage=1'><<</a> ";
						   // get previous page num
						   $prevpage = $currentpage - 1;
						   // show < link to go back to 1 page
						   echo " <a href='?pg=news&currentpage=$prevpage'><</a> ";
						} // end if 
						...
						for ($x = ($currentpage - $range); $x < (($currentpage + $range) + 1); $x++) {
						   ...
						   if (($x > 0) && ($x <= $totalpages)) {
							  ...
							  // if not current page...
								 ...
								 // make it a link
								 echo " <a href='?pg=news&currentpage=$x'>$x</a> ";
							  } // end else
						   } // end if 
						} // end for
						...
						if ($currentpage != $totalpages) {
						   ...
						   echo " <a href='?pg=news&currentpage=$nextpage'>></a> ";
						   // echo forward link for lastpage
						   echo " <a href='?pg=news&currentpage=$totalpages'>>></a> ";
						} // end if
		...
		<div id="templatemo_content3" style="text-align:left;">
			<h3 style="color: #2E8B57;margin-top:-10.3cm;"><b>RECENT EVENTS</h2></b>
		...
		<?php
			...
			while($r=mysql_fetch_array($q1))
			{
				...
				echo '<img style="width:150px;height:69px;margin-top:-0.2cm;" src="data:image/jpeg;base64,'.base64_encode( $r['newsimage'] ).'"/>';
				 ...
				 ?>
				 <p ><?php echo $newscontent; ?>...<a href="events.php?newsid=<?php echo $newsid; ?>"> read more </a></p>
											
				 <div class="cleaner_h20 horizon_divider" style="margin-top:-0.3cm;"></div>
